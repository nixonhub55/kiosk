                        ...
                        <table class="table data-table" id="datatablesPending">
                              ...
                              <tr>
                                    <td>
                                          ...
                                          @else
                                          <center>
                                                <input class="form-check-input" id="chkbox{{$num}}" type="checkbox" value="{{$rows->enc_id}}" name="{{$rows->laAppNo}}" onclick="return CheckMe(1,this.id,'selectAll','datatablesPending')">
                                          </center>
                                          @endif
                                    ...
                                    <td id="td{{$rows->laAppNo}}"> 
                                          <label class="fixed_lbl" id="lbl{{$rows->laAppNo}}" for="txt{{$rows->laAppNo}}"></label>
                                          <input type="text" id="txt{{$rows->laAppNo}}" class="form-control" maxlength="200"> 
                                    </td>
                                                
                                    <td>
                                          <div class="btn-container"> 
                                                <button id="{{$rows->laAppNo}}" class="btn btn-action btn-view" title="More Details" onclick="view_leave_details('{{$rows->enc_id}}',this.id,'{{$rows->enc_pay}}')"><i
                  ...
                  <div class="table-container">
                        <div class="container">
                              <div class="row bg-light rounded p-2"> 
                                    ...
                                    <button class="btn btn-primary" id="btnFilter" onclick="Filter_History(1,this.id,1)">
