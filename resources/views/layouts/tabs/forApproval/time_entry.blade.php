...
<div class="container-fluid mt-4 card-container">
      ...
      <div class="modal fade" id="teModal" tabindex="-1" aria-labelledby="teModalLabel"  aria-hidden="true"><!-- modal -->
            <div class="modal-dialog modal-lg">
                  <div class="modal-content">
                        <div class="modal-header bg-primary text-white">
                              <h5 class="modal-title" id="teModalLabel">Time Entry Application Details</h5>
                              ...
                              <tbody>
                                    ...
                                    <tr>
                                          <td>
                                                ...
                                                @else
                                                <center>
                                                <input class="form-check-input" id="chkbox{{$num}}" type="checkbox" value="{{$rows->enc_id}}" name="{{$rows->teAppNo}}" onclick="return CheckMe(1,this.id,'selectAll','datatablesPending')">
                                                </center>
                                                @endif
                                          ...
                                          <td>{{$rows->teID}}</td>
                                          <td>{{$rows->teName}}</td>
                                          <td>{{$rows->teCosCenter}}</td>
                                          <td>{{$rows->department}}</td>
                                          <td>{{$rows->teDate}}</td> 
                                          <td>{{$rows->teType}}</td>
                                          <td>{{$rows->teReason}}</td> 

                                          <td id="td{{$rows->teAppNo}}"> 
                                                <label class="fixed_lbl" id="lbl{{$rows->teAppNo}}" for="txt{{$rows->teAppNo}}"></label>
                                                <input type="text" id="txt{{$rows->teAppNo}}" class="form-control" maxlength="200"> 
                                          </td> 

                                          <td>
                                                <div class="btn-container"> 
                                                      <button id="{{$rows->teAppNo}}" class="btn btn-action btn-view" title="More Details" onclick="view_ta_details('{{$rows->enc_id}}',this.id,'{{$rows->enc_pay}}')"><i
                  ...
                  <div class="table-container">   
                        <div class="container"> 
                              <div class="row bg-light rounded p-2"> 
                                    ...
                                    <button class="btn btn-primary" id="btnFilter" onclick="Filter_History(1,this.id,5)">
